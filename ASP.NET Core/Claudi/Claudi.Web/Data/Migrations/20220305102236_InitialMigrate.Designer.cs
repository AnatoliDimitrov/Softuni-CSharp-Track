...
namespace Claudi.Web.Data.Migrations
{
    ...
    [Migration("20220305102236_InitialMigrate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ConfiguredProduct", b =>
                {
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ProductCatalogue", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ProductColor", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ProductExtra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ProductModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Claudi.Web.Models.DataBaseModels.ConfiguredProduct", b =>
                {
                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductColor", "Color")
                        .WithMany("ConfiguredProducts")
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductModel", "Model")
                        .WithMany("ConfiguredProducts")
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductType", "Type")
                        .WithMany("ConfiguredProducts")
            ...
            modelBuilder.Entity("ConfiguredProductProductExtra", b =>
                {
                    b.HasOne("Claudi.Web.Models.DataBaseModels.ConfiguredProduct", null)
                        .WithMany()
                        .HasForeignKey("ConfiguredProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductExtra", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductCatalogueProductModel", b =>
                {
                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductCatalogue", null)
                        .WithMany()
                        .HasForeignKey("CataloguesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductColorProductModel", b =>
                {
                    b.HasOne("Claudi.Web.Models.DataBaseModels.ProductColor", null)
                        .WithMany()
